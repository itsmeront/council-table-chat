// =====================================================================
// noble-ed25519.js — VENDORED from @noble/ed25519 v2.3.0 (MIT, Paul Miller).
//   https://github.com/paulmillr/noble-ed25519  —  unmodified.
// Pure-JS Ed25519 used as the software fallback when WebCrypto lacks native
// Ed25519 (old Chrome/Samsung Internet/WebViews). Vendored, not an npm dep, so
// it rides along through the consumers' sync-protocol.sh copy step and keeps
// the kernel's zero-external-runtime-deps property. Default sha512Async uses
// crypto.subtle.digest('SHA-512'), which is universally supported.
// =====================================================================
